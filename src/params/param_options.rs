...
impl ModeOption {
    ...
    pub const VARIANTS: &'static [ParamOptionVariant] = &[
        Self::STANDBY, Self::MOTION_TRACKING, Self::PERMANENT_TRACKING, Self::MOTION_START_END_TRACKING, Self::ACTIVITY_TRACKING, Self::OFF
    ];
}
...
impl GeolocSensorOption {
    ...
    pub const VARIANTS: &'static [ParamOptionVariant] = &[
        ...
        Self::WIFI_GPS, Self::WIFI_LPGPS, 
        // Self::RESERVED_8,
        Self::WIFI_LPGPS_WIFI_GPS, Self::BLE, Self::BLE_GPS, Self::BLE_LPGPS
    ];
...
impl GeolocMethodOption {
    ...
    pub const VARIANTS: &'static [ParamOptionVariant] = &[
        Self::WIFI, Self::GPS, Self::LPGPS, Self::WIFI_GPS, Self::WIFI_LPGPS, Self::BLE, Self::BLE_GPS, Self::BLE_LPGPS
    ];
...
impl TransmitStratOption {
    ...
    pub const VARIANTS: &'static [ParamOptionVariant] = &[
        Self::SINGLE_FIXED, Self::SINGLE_RANDOM, Self::DOUBLE_RANDOM, Self::DOUBLE_FIXED, 
        // Self::RESERVED, 
        Self::CUSTOM,
    ];
}
