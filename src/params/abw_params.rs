...
pub fn name_to_id_map() -> &'static BTreeMap<&'static str, u8> {
    NAME_TO_ID.get_or_init(|| BTreeMap::from(PARAMS))   
}
...
static NAME_TO_VALUE: OnceLock<BTreeMap<&str, i32>> = OnceLock::new();

pub fn name_to_value_map() -> &'static BTreeMap<&'static str, i32> {
    NAME_TO_VALUE.get_or_init(|| BTreeMap::new())   
}
